...
void CHudFmodPlayer::EmitAmbience(std::string msg, bool looping, FMOD_VECTOR fmod_pos, FMOD_VECTOR vel, float volume, float min_atten, float max_atten, float pitch)
{
...
bool CHudFmodPlayer::MsgFunc_FmodAmb(const char* pszName, int iSize, void* pbuf)
{
	...
	EmitAmbience(msg, looping, fmod_pos, vel, volume, min_atten, max_atten, pitch);
